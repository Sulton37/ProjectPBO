...
public class Puzzle extends Frame implements ActionListener {
    ...
    Puzzle() {
        ...
        setBackground(new Color(255, 255, 240)); // Warna latar belakang
        ...
        b2.setBounds(150, 100, 80, 80);
        b3.setBounds(250, 100, 80, 80);
        b4.setBounds(50, 200, 80, 80);
        b5.setBounds(150, 200, 80, 80);
        b6.setBounds(250, 200, 80, 80);
        b7.setBounds(50, 300, 80, 80);
        b8.setBounds(150, 300, 80, 80);
        b9.setBounds(250, 300, 80, 80);
        ...
        setSize(400, 500); // Mengubah ukuran frame
        setLayout(null);
        setVisible(true);
    }
    ...
    private Button createButton(String label) {
        ...
        button.setFont(new Font("Arial", Font.BOLD, 24)); // Mengatur ukuran dan gaya font teks tombol
        button.setBackground(new Color(135, 206, 250)); // Warna latar tombol
        button.setForeground(new Color(0, 0, 128)); // Warna teks tombol
        return button;
    }
